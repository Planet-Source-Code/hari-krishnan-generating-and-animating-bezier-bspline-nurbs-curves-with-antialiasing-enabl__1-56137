VERSION 5.00
Begin VB.Form frmBsp 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   " BSP Curve Drawing Window"
   ClientHeight    =   7560
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9570
   Icon            =   "frmBsp.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7560
...
Public Sub DrawPnts()
    ...
    For i = 0 To pnt.count - 1
        ...
        PP.Print i + 1
        If (i > 0) Then PP.Line (pnt.point(i - 1).x, pnt.point(i - 1).y)-(pnt.point(i).x, pnt.point(i).y), RGB(50, 50, 50)
    Next i
